(function () {
  ...
  window.WPD.ajaxsearchlite = new (function () {
    ...
    this.addons = {
      addons: [],
      add: function (d) {
        -1 == this.addons.indexOf(d) &&
          ((d = this.addons.push(d)), this.addons[d - 1].init());
      },
      remove: function (d) {
        this.addons.filter(function (b) {
          return b.name == d
            ? ("undefined" != typeof b.destroy && b.destroy(), !1)
            : !0;
        });
      },
    };
...
(function (d) {
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    setFilterStateInput: function (a) {
      ...
      let f = function () {
        JSON.stringify(c.originalFormData) !=
        JSON.stringify(b.formData(d("form", c.n("searchsettings"))))
          ? c.n("searchsettings").find("input[name=filters_initial]").val(0)
          : c.n("searchsettings").find("input[name=filters_initial]").val(1);
      };
      0 == a
        ? f()
        : setTimeout(function () {
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    liveLoad: function (a, c, f, e) {
      function l(h) {
        ...
        if ("" != h && 0 < q.length && 0 < q.find(a).length) {
          h = h.replace(/&asl_force_reset_pagination=1/gim, "");
          h = h.replace(/%26asl_force_reset_pagination%3D1/gim, "");
          h = h.replace(/&#038;asl_force_reset_pagination=1/gim, "");
          b.isSafari() && (h = h.replace(/srcset/gim, "nosrcset"));
          h = b.Hooks.applyFilters("asl/live_load/html", h, g.o.id, g.o.iid);
          h = b.wp_hooks_apply_filters(
            "asl/live_load/html",
            h,
            g.o.id,
            g.o.iid
          ...
          n = q.find(a).get(0);
          n = b.Hooks.applyFilters(
            "asl/live_load/replacement_node",
            n,
            g,
            k.get(0),
            h
          ...
          k = d(a).first();
          f && ((document.title = p.title), history.pushState({}, null, c));
          d(a)
            .first()
          ...
          if (1 == g.o.singleHighlight)
            d(a)
              .find("a")
              .on("click", function () {
                localStorage.removeItem("asl_phrase_highlight");
                "" != b.unqoutePhrase(g.n("text").val()) &&
                  localStorage.setItem(
                    "asl_phrase_highlight",
                    JSON.stringify({
                      phrase: b.unqoutePhrase(g.n("text").val()),
                    })
                  );
              });
          b.Hooks.applyFilters("asl/live_load/finished", c, g, a, k.get(0));
          ASL.initialize();
          g.lastSuccesfulSearch =
            d("form", g.n("searchsettings")).serialize() +
            g.n("text").val().trim();
          g.lastSearchData = h;
        }
        g.n("s").trigger(
          "asl_search_end",
          [g.o.id, g.o.iid, g.n("text").val(), h],
          !0,
          !0
        );
        let r, t;
        null == (t = (r = g).gaEvent) ||
          t.call(r, "search_end", { results_count: "unknown" });
        let u, v;
        null == (v = (u = g).gaPageview) || v.call(u, g.n("text").val());
        g.hideLoader();
        k.css("opacity", 1);
        g.searching = !1;
        "" != g.n("text").val() && g.n("proclose").css({ display: "block" });
      }
      if ("body" == a || "html" == a)
        return (
          console.log(
            "Ajax Search Pro: Do not use html or body as the live loader selector."
          ),
          !1
        );
      "" == ASL.pageHTML &&
        "undefined" === typeof ASL._ajax_page_html &&
        ((ASL._ajax_page_html = !0),
        d.fn.ajax({
          url: location.href,
          method: "GET",
          success: function (h) {
      ...
      let m =
        ".search-content #content #Content div[role=main] main[role=main] div.theme-content div.td-ss-main-content main.l-content #primary".split(
          " "
        );
      ...
      if (
        ...
        (m.forEach(function (h) {
          if (0 < d(h).length) return (a = h), !1;
        }),
        1 > d(a).length)
      )
        return (
          console.log(
            "Ajax Search Lite: The live search selector does not exist on the page."
          ),
          !1
        );
      ...
      e ||
      1 != g.n("searchsettings").find("input[name=filters_initial]").val() ||
      "" != g.n("text").val()
        ? ((g.searching = !0),
          (g.post = d.fn.ajax({
            url: c,
            ...
            fail: function (h) {
              ...
              h.aborted ||
                ...
                g.hideLoader(),
                (g.searching = !1),
                g.n("proclose").css({ display: "block" }));
            },
          })))
    ...
    getCurrentLiveURL: function () {
      ...
      a =
        ...
        c +
        a +
        "&asl_active=1&asl_force_reset_pagination=1&p_asid=" +
        this.o.id +
        "&p_asl_data=1&" +
        d("form", this.n("searchsettings")).serialize();
      return (a = a.replace("?&", "?"));
    },
  });
})(WPD.dom);
...
(function (d) {
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    loadASLFonts: function () {
      !1 !== ASL.font_url &&
        (new FontFace("aslsicons2", "url(" + ASL.font_url + ")", {
          style: "normal",
          weight: "normal",
          "font-display": "swap",
        })
    ...
    updateHref: function () {
      if (this.o.trigger.update_href && !this.usingLiveLoader) {
        ...
        let b =
          this.getStateURL() +
          (this.resultsOpened ? "&asl_s=" : "&asl_ls=") +
          this.n("text").val();
    ...
    fixClonedSelf: function () {
      ...
      b != this.o.iid &&
        ...
        this.n("search")
          .removeClass("asl_m_" + a)
          .addClass("asl_m_" + this.o.rid)
          .data("instance", this.o.iid),
        (this.n("searchsettings").get(0).id = this.n("searchsettings")
          .get(0)
          .id.replace("settings" + a, "settings" + this.o.rid)),
        this.n("searchsettings").hasClass("asl_s_" + a)
          ? this.n("searchsettings")
              .removeClass("asl_s_" + a)
              .addClass("asl_s_" + this.o.rid)
              .data("instance", this.o.iid)
          : this.n("searchsettings")
              .removeClass("asl_sb_" + a)
              .addClass("asl_sb_" + this.o.rid)
              .data("instance", this.o.iid),
        (this.n("resultsDiv").get(0).id = this.n("resultsDiv")
          .get(0)
          .id.replace("prores" + a, "prores" + this.o.rid)),
        this.n("resultsDiv")
          .removeClass("asl_r_" + a)
          .addClass("asl_r_" + this.o.rid)
          .data("instance", this.o.iid),
        this.n("container").find(".asl_init_data").data("instance", this.o.iid),
        (this.n("container").find(".asl_init_data").get(0).id = this.n(
          "container"
        )
          .find(".asl_init_data")
          .get(0)
          .id.replace("asl_init_id_" + a, "asl_init_id_" + this.o.rid)),
...
(function (d) {
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    isRedirectToFirstResult: function () {
      return (
        (0 < d(".asl_res_url", this.n("resultsDiv")).length ||
          0 < d(".asl_es_" + this.o.id + " a").length ||
          (this.o.resPage.useAjax &&
            0 < d(this.o.resPage.selector + "a").length)) &&
        ((1 == this.o.redirectOnClick &&
          "click" == this.ktype &&
          "first_result" == this.o.trigger.click) ||
          (1 == this.o.redirectOnEnter &&
            ("input" == this.ktype || "keyup" == this.ktype) &&
            13 == this.keycode &&
    ...
    doRedirectToFirstResult: function () {
      ...
      a =
        "click" == this.ktype
          ? this.o.trigger.click_location
          : this.o.trigger.return_location;
      0 < d(".asl_res_url", this.n("resultsDiv")).length
        ? (c = d(d(".asl_res_url", this.n("resultsDiv")).get(0)).attr("href"))
        : 0 < d(".asl_es_" + this.o.id + " a").length
        ? (c = d(d(".asl_es_" + this.o.id + " a").get(0)).attr("href"))
        : this.o.resPage.useAjax &&
          0 < d(this.o.resPage.selector + "a").length &&
          (c = d(d(this.o.resPage.selector + "a").get(0)).attr("href"));
      "" != c &&
        ("same" == a ? (location.href = c) : b.openInNewTab(c),
        this.hideLoader(),
        this.hideResults());
      return !1;
    },
    ...
    getRedirectURL: function (a) {
      a =
        "click" == ("undefined" !== typeof a ? a : "enter")
          ? this.o.trigger.click
          : this.o.trigger.return;
      "results_page" == a || "ajax_search" == a
        ? (a = "?s=" + b.nicePhrase(this.n("text").val()))
        : "woo_results_page" == a
        ? (a = "?post_type=product&s=" + b.nicePhrase(this.n("text").val()))
        : ((a = this.o.trigger.redirect_url),
          (a = a.replace(/{phrase}/g, b.nicePhrase(this.n("text").val()))));
      1 < this.o.homeurl.indexOf("?") &&
        0 === a.indexOf("?") &&
        (a = a.replace("?", "&"));
      ...
      return (a = b.wp_hooks_apply_filters(
        "asl/redirect/url",
        a,
        this.o.id,
        this.o.iid
...
(function (d) {
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    showResults: function () {
      ...
      null != this.n("showmore") &&
        (0 < this.n("items").length
          ? this.n("showmore").css({ display: "block" })
          : this.n("showmore").css({ display: "none" }));
      "undefined" != typeof WPD.lazy &&
        setTimeout(function () {
          WPD.lazy(".asl_lazy");
        }, 100);
    ...
    hideResults: function (a) {
      ...
      if (!c.resultsOpened) return !1;
      c.n("resultsDiv")
        .removeClass(c.resAnim.showClass)
        .addClass(c.resAnim.hideClass);
      setTimeout(function () {
        c.n("resultsDiv").css(c.resAnim.hideCSS);
      }, c.resAnim.duration);
      c.n("proclose").css({ display: "none" });
    ...
    showResultsBox: function () {
      ...
      this.n("resultsDiv").css({ display: "block", height: "auto" });
      this.n("resultsDiv").css(this.resAnim.showCSS);
      this.n("resultsDiv")
        .removeClass(this.resAnim.hideClass)
        .addClass(this.resAnim.showClass);
      this.fixResultsPosition(!0);
    },
    scrollToResults: function () {
      var a = Math.floor(0.1 * window.innerHeight);
      if (
        this.resultsOpened &&
        1 == this.o.scrollToResults.enabled &&
        !this.n("resultsDiv").inViewPort(a)
      ) {
        a =
          "hover" == this.o.resultsposition
            ? this.n("probox").offset().top - 20
            : this.n("resultsDiv").offset().top - 20;
        a += this.o.scrollToResults.offset;
        var c = d("#wpadminbar");
        0 < c.length && (a -= c.height());
        window.scrollTo({ top: 0 > a ? 0 : a, behavior: "smooth" });
      }
    },
  });
})(WPD.dom);
...
(function (d) {
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    ...
    searchWithCheck: function (a) {
      ...
      c.n("text").val().length < c.o.charcount ||
        (c.searchAbort(),
    ...
    search: function () {
      ...
      if (!(a.n("text").val().length < a.o.charcount)) {
        a.searching = !0;
        a.n("proloading").css({ display: "block" });
          ...
          : (a.post = d.fn.ajax({
              ...
              success: function (e) {
                ...
                if (a.isRedirectToFirstResult())
                  return a.doRedirectToFirstResult(), !1;
                a.hideLoader();
                a.showResults();
                a.scrollToResults();
                a.lastSuccesfulSearch =
                ...
                0 == a.n("items").length
                  ? null != a.n("showmore") &&
                    a.n("showmore").css("display", "none")
                  : null != a.n("showmore") &&
                    (a.n("showmore").css("display", "block"),
                    d("a", a.n("showmore")).off(),
                    d("a", a.n("showmore")).on("click", function () {
                      var k = a.o.trigger.click;
                      k =
                        "results_page" == k
                          ? "?s=" + b.nicePhrase(a.n("text").val())
                          : "woo_results_page" == k
                          ? "?post_type=product&s=" +
                            b.nicePhrase(a.n("text").val())
                          : a.o.trigger.redirect_url.replace(
                              "{phrase}",
                              b.nicePhrase(a.n("text").val())
                            );
                      a.o.overridewpdefault
                        ? "post" == a.o.override_method
                          ? b.submitToUrl(a.o.homeurl + k, "post", {
                              asl_active: 1,
                              p_asl_data: d(
                                "form",
                                a.n("searchsettings")
              ...
              fail: function (e) {
                e.aborted ||
                  ...
                  a
                    .n("resdrg")
                    .html(
                      '<div class="asl_nores">The request failed. Please check your connection! Status: ' +
                        e.status +
                        "</div>"
                    ),
                  (a.nodes.items = d(".item", a.n("resultsDiv"))),
...
(function (d) {
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    ...
    toggleSettings: function (b) {
      "undefined" != typeof b
        ? "show" == b
          ? this.showSettings()
          : this.hideSettings()
        : 1 == this.n("prosettings").data("opened")
        ? this.hideSettings()
        : this.showSettings();
    },
    ...
    filtersInitial: function () {
      return (
        1 == this.n("searchsettings").find("input[name=filters_initial]").val()
      );
    },
    filtersChanged: function () {
      return (
        1 == this.n("searchsettings").find("input[name=filters_changed]").val()
      );
    },
  });
})(WPD.dom);
(function (d) {
  d.fn.extend(window.WPD.ajaxsearchlite.helpers, {
    ...
    detectIOS: function () {
      return "undefined" != typeof window.navigator &&
        "undefined" != typeof window.navigator.userAgent
        ? null != window.navigator.userAgent.match(/(iPod|iPhone|iPad)/)
        : !1;
    },
    detectIE: function () {
    ...
    whichjQuery: function (b) {
      ...
      "undefined" != typeof window.$ &&
        ("undefined" === typeof b
          ? (a = window.$)
          : "undefined" != typeof window.$.fn[b] && (a = window.$));
      !1 === a &&
        "undefined" != typeof window.jQuery &&
        ((a = window.jQuery),
        "undefined" === typeof b
          ? (a = window.jQuery)
          : "undefined" != typeof window.jQuery.fn[b] && (a = window.jQuery));
      return a;
    },
        ...
        return (
          ...
          f.forEach(function (e) {
            e.name &&
              !e.disabled &&
              (e.checked ||
                /select|textarea/i.test(e.nodeName) ||
                /text/i.test(e.type) ||
                d(e).hasClass("hasDatepicker") ||
                d(e).hasClass("asl_slider_hidden")) &&
              (void 0 == a[e.name] && (a[e.name] = []),
              d(e).hasClass("hasDatepicker")
                ? a[e.name].push(
                    d(e).parent().find(".asl_datepicker_hidden").val()
                  )
                : a[e.name].push(d(e).val()));
          }),
          JSON.stringify(a)
        );
        ...
        if (e.name)
          if (a[e.name]) {
            ...
            if ("checkbox" == e.type || "radio" == e.type) {
              ...
              m.val(l[0]),
                (d(e).hasClass("asl_gochosen") ||
                  d(e).hasClass("asl_goselect2")) &&
                  WPD.intervalUntilExecute(
                    function (k) {
      ...
      b =
        -1 < b.indexOf("px")
          ...
          ? "undefined" != typeof a && null != a
            ? Math.floor((parseInt(b, 10) / 100) * a)
            : parseInt(b, 10)
          : parseInt(b, 10);
      return 100 > b ? 100 : b;
    },
    ...
    decodeHTMLEntities: function (b) {
      ...
      b &&
        "string" === typeof b &&
        ((b = b.replace(/<script[^>]*>([\S\s]*?)<\/script>/gim, "")),
        (b = b.replace(/<\/?\w(?:[^"'>]|"[^"]*"|'[^']*')*>/gim, "")),
        (a.innerHTML = b),
        (b = a.textContent),
        (a.textContent = ""));
    ...
    wp_hooks_apply_filters: function () {
      return "undefined" != typeof wp &&
        ...
        "undefined" != typeof wp.hooks.applyFilters
...
(function (d) {
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    detectAndFixFixedPositioning: function () {
      ...
      a || "fixed" == this.n("search").css("position")
        ? ("absolute" == this.n("resultsDiv").css("position") &&
        ...
        : ("fixed" == this.n("resultsDiv").css("position") &&
    ...
    fixResultsPosition: function (a) {
      ...
      if (0 != d._fn.bodyTransformY() || "static" != c.css("position"))
        f = c.offset().top;
      0 != d._fn.bodyTransformY() &&
        "fixed" == e &&
        ((e = "absolute"), this.n("resultsDiv").css("position", "absolute"));
      "fixed" == e && (f = 0);
      if ("fixed" == e || "absolute" == e)
        if (1 == a || "visible" == this.n("resultsDiv").css("visibility")) {
          ...
          if ("undefined" != typeof a) {
            ...
            c =
              "phone" == b.deviceType()
                ? this.o.results.width_phone
                : "tablet" == b.deviceType()
                ? this.o.results.width_tablet
                : this.o.results.width;
            "auto" == c &&
              (c =
                240 > this.n("search").outerWidth()
                  ? 240
                  : this.n("search").outerWidth());
            this.n("resultsDiv").css("width", isNaN(c) ? c : c + "px");
            "right" == this.o.resultsSnapTo
              ? (l =
                  this.n("resultsDiv").outerWidth() -
                  this.n("search").outerWidth())
              : "center" == this.o.resultsSnapTo &&
                (l = Math.floor(
                  (this.n("resultsDiv").outerWidth() -
                    parseInt(this.n("search").outerWidth())) /
                    2
                ));
            this.n("resultsDiv").css({
    ...
    fixSettingsPosition: function (a) {
      ...
      if (1 == a || 0 != this.n("prosettings").data("opened")) {
        ...
        c =
          "none" != this.n("prosettings").css("display")
            ? this.n("prosettings")
            : this.n("promagnifier");
        e = c.offset();
        f = e.top + c.height() - 2 - f + "px";
        c =
          "left" == this.o.settingsimagepos
            ? e.left
            : e.left + c.width() - this.n("searchsettings").width();
        c = c - a + "px";
        this.n("searchsettings").css({ display: "block", top: f, left: c });
      }
    },
    fixSettingsWidth: function () {},
    hideOnInvisibleBox: function () {
      if (
        1 == this.o.detectVisibility &&
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    initMagnifierEvents: function () {
      ...
      b.n("promagnifier").on("click", function (a) {
        ...
        if (
          b.n("text").val().length >= b.o.charcount &&
          1 == b.o.redirectOnClick &&
          "first_result" != b.o.trigger.click
        )
          return b.doRedirectToResults("click"), clearTimeout(void 0), !1;
        if (
          "ajax_search" != b.o.trigger.click &&
          "first_result" != b.o.trigger.click
        )
          return !1;
        b.searchAbort();
        ...
        b.timeouts.search = setTimeout(function () {
          d("form", b.n("searchsettings")).serialize() +
            b.n("text").val().trim() !=
            b.lastSuccesfulSearch ||
          (!b.resultsOpened && !b.usingLiveLoader)
            ? b.search()
            : b.isRedirectToFirstResult()
            ? b.doRedirectToFirstResult()
            : b.n("proclose").css("display", "block");
        }, b.o.trigger.delay);
      });
    },
  });
...
(function (d) {
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    initInputEvents: function () {
      ...
      a.n("text").on("mousedown touchstart keydown", f, { passive: !0 });
    },
    _initFocusInput: function () {
      ...
      a.n("text").on("focus input", function (c) {
        a.searching ||
          ("" != d(this).val()
            ? a.n("proclose").css("display", "block")
            : a.n("proclose").css({ display: "none" }));
      });
    },
      ...
      a.n("text").on("input", function (f) {
        ...
        a.timeouts.search = setTimeout(function () {
          d("form", a.n("searchsettings")).serialize() +
            a.n("text").val().trim() !=
            a.lastSuccesfulSearch ||
          (!a.resultsOpened && !a.usingLiveLoader)
            ? a.search()
            : a.isRedirectToFirstResult()
            ? a.doRedirectToFirstResult()
            : a.n("proclose").css("display", "block");
        }, a.o.trigger.delay);
      });
    },
    _initEnterEvent: function () {
      ...
      a.n("text").on("keyup", function (e) {
        ...
        if (a.n("text").val().length >= a.o.charcount && e && 13 == a.keycode) {
          ...
          1 == a.o.redirectOnEnter
            ? "first_result" != a.o.trigger.return
              ? a.doRedirectToResults(a.ktype)
              : a.search()
            : "ajax_search" == a.o.trigger.return &&
              (d("form", a.n("searchsettings")).serialize() +
                a.n("text").val().trim() !=
                a.lastSuccesfulSearch ||
                (!a.resultsOpened && !a.usingLiveLoader)) &&
        ...
        b.isMobile()
          ? a.o.redirectOnEnter
            ? ((c = new Event("keyup")),
              ...
              this.n("text").get(0).dispatchEvent(c))
            : (a.search(), document.activeElement.blur())
          : "undefined" != typeof f && "ajax" == f && a.search();
      });
    },
  });
})(WPD.dom);
    ...
    initNavigationEvents: function () {
      let b = this,
        a = function (c) {
          ...
          if (
            0 < d(".item", b.n("resultsDiv")).length &&
            "none" != b.n("resultsDiv").css("display") &&
            ...
            if (40 == f || 38 == f) {
              ...
              0 == e.length
                ? b.n("resultsDiv").find(".item").first().addClass("hovered")
                : (40 == f &&
                    (0 == e.next(".item").length
                      ? b
                          .n("resultsDiv")
                          .find(".item")
                          .removeClass("hovered")
              ...
              b
                .n("resultsDiv")
                .find(".resdrg .item.hovered")
                .inViewPort(50, b.n("resultsDiv").get(0)) ||
                ((e = b.n("resultsDiv").find(".resdrg .item.hovered").get(0)),
                null != e &&
                  "undefined" != typeof e.scrollIntoView &&
                  e.scrollIntoView({
                    behavior: "smooth",
                    block: "start",
                    inline: "nearest",
            ...
            13 == f &&
              0 < d(".item.hovered", b.n("resultsDiv")).length &&
              (c.stopPropagation(),
              c.preventDefault(),
              d(".item.hovered a.asl_res_url", b.n("resultsDiv"))
                .get(0)
                .click());
          }
        };
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    initOtherEvents: function () {
      ...
      if (b.isMobile()) {
        ...
        (c = function () {
          ...
          d(window).on("resize", c, { passive: !0 });
      c = function () {
        a.scrolling(!1);
      };
      a.documentEventHandlers.push({
      ...
      d(window).on("scroll", c, { passive: !0 });
      ...
      b.detectIOS() &&
        b.isMobile() &&
        b.isTouchDevice() &&
        16 > parseInt(a.n("text").css("font-size")) &&
        (a
          .n("text")
          .data("fontSize", a.n("text").css("font-size"))
          .css("font-size", "16px"),
        a.n("textAutocomplete").css("font-size", "16px"),
        d("body").append(
          "<style>#ajaxsearchlite" +
            a.o.rid +
            " input.orig::-webkit-input-placeholder{font-size: 16px !important;}</style>"
        ));
    },
    orientationChange: function () {
      ...
      "isotopic" == this.o.resultstype &&
        "visible" == this.n("resultsDiv").css("visibility") &&
    ...
    initTryThisEvents: function () {
      let a = this;
      0 < a.n("trythis").find("a").length &&
        (a
          .n("trythis")
          .find("a")
          .on("click touchend", function (c) {
            c.preventDefault();
            c.stopImmediatePropagation();
        ...
        a.n("trythis").css({ visibility: "visible" }));
    },
  });
})(WPD.dom);
(function (d) {
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    initResultsEvents: function () {
      let b = this;
      b.n("resultsDiv").css({ opacity: "0" });
      let a = function (c) {
        let f = c.keyCode || c.which,
          e = c.type;
        0 == d(c.target).closest(".asl_w").length &&
          (b.hideOnInvisibleBox(),
          ("click" == e && "touchend" == e && 3 == f) ||
            0 == b.resultsOpened ||
            1 != b.o.closeOnDocClick ||
            b.dragging ||
            (b.hideLoader(), b.searchAbort(), b.hideResults()));
      };
      b.documentEventHandlers.push({
        node: document,
      ...
      b.n("resultsDiv").on("click", ".results .item", function () {
        let c;
        null == (c = b.gaEvent) ||
          c.call(b, "result_click", {
            result_title: d(this).find("a.asl_res_url").text(),
            result_url: d(this).find("a.asl_res_url").attr("href"),
          });
        1 == b.o.singleHighlight &&
          (localStorage.removeItem("asl_phrase_highlight"),
          "" != b.n("text").val().replace(/["']/g, "") &&
            localStorage.setItem(
              "asl_phrase_highlight",
              JSON.stringify({ phrase: b.n("text").val().replace(/["']/g, "") })
            ));
      });
    },
  });
...
(function (d) {
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    initAutop: function () {
      let b = this;
      if ("disabled" == b.o.autop.state) return !1;
      let a = window.location.href;
      if (-1 < a.indexOf("asl_ls=") || -1 < a.indexOf("asl_ls&")) return !1;
      let c = b.o.autop.count;
      window.WPD.intervalUntilExecute(
        function () {
          b.isAutoP = !0;
          "phrase" == b.o.autop.state
            ? (b.o.is_results_page || b.n("text").val(b.o.autop.phrase),
              b.search(c))
            : "latest" == b.o.autop.state
            ? b.search(c, 1)
            : b.search(c, 2);
        },
        function () {
          return (
            !window.ASL.css_async || "undefined" != typeof window.ASL.css_loaded
          );
        }
      );
    },
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    init: function (c, f) {
      ...
      this.animationOpacity =
        0 > this.animOptions.items.indexOf("In") ? "opacityOne" : "opacityZero";
      this.o.redirectOnClick =
        "ajax_search" != this.o.trigger.click &&
        "nothing" != this.o.trigger.click;
      this.o.redirectOnEnter =
        "ajax_search" != this.o.trigger.return &&
        "nothing" != this.o.trigger.return;
      if (
        (this.usingLiveLoader =
          (this.o.resPage.useAjax && 0 < d(this.o.resPage.selector).length) ||
          0 < d(".asl_es_" + this.o.id).length)
      )
        (this.o.trigger.type = this.o.resPage.trigger_type),
          (this.o.trigger.facet = this.o.resPage.trigger_facet),
          this.o.resPage.trigger_magnifier &&
            ((this.o.redirectOnClick = 0),
            (this.o.trigger.click = "ajax_search")),
          this.o.resPage.trigger_return &&
    ...
    n: function (c) {
      if ("undefined" === typeof this.nodes[c])
        switch (c) {
          ...
          case "items":
            this.nodes[c] =
              0 < d(".item", this.n("resultsDiv")).length
                ? d(".item", this.n("resultsDiv"))
                : d(".photostack-flip", this.n("resultsDiv"));
            break;
          case "results":
...
(function (d) {
  ...
  d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
    ...
    initResultsBox: function () {
      ...
      b.isMobile() && 1 == this.o.mobile.force_res_hover
        ? ((this.o.resultsposition = "hover"),
          (this.nodes.resultsDiv = this.n("resultsDiv").clone()),
          d("body").append(this.nodes.resultsDiv),
          this.nodes.resultsDiv.css({ position: "absolute" }),
          this.detectAndFixFixedPositioning())
        : "hover" == this.o.resultsposition &&
          0 >= this.n("resultsAppend").length
        ? ((this.nodes.resultsDiv = this.n("resultsDiv").clone()),
          d("body").append(this.n("resultsDiv")))
        : ((this.o.resultsposition = "block"),
          this.n("resultsDiv").css({ position: "static" }),
          0 < this.n("resultsAppend").length &&
            (0 < this.n("resultsAppend").find(".asl_w").length
...
window.ASL.api = function () {
  let d = function (c, f, e, l) {
    ...
    b = function (c, f, e) {
      if (!isNaN(parseFloat(f)) && isFinite(f))
        return (c = ASL.instances.get(c, f)), !1 !== c && c[e].apply(c);
    ...
    a = function (c, f) {
      if ("exists" == f) return ASL.instances.exist(c);
      c = ASL.instances.get(c);
      return (
        !1 !== c &&
  ...
  if (3 == arguments.length) return b.apply(this, arguments);
  if (2 == arguments.length) return a.apply(this, arguments);
  0 == arguments.length &&
    (console.log(
      "Usage: ASL.api(id, [optional]instance, function, [optional]args);"
    ),
    console.log(
      "For more info: https://knowledgebase.ajaxsearchlite.com/other/javascript-api"
    ));
};
