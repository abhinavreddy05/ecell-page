(function () {
  ...
  if ("undefined" != typeof WPD.dom) return !1;
  WPD.dom = function () {
      ...
      (WPD.dom.fn = {
        ...
        get: function (a) {
          return "undefined" == typeof a
            ? this.a.slice()
            : "undefined" != typeof this.a[a]
            ? this.a[a]
            : null;
        },
        _: function (a) {
          return "<" === a.charAt(0)
            ? WPD.dom._fn.createElementsFromHTML(a)
        ...
        copy: function (a, b) {
          ...
          for (d in a)
            a.hasOwnProperty(d) &&
              ((e = typeof a[d]),
              (c[d] =
                b && "object" === e && null !== a[d] ? this.copy(a[d]) : a[d]));
          return c;
        },
        parent: function (a) {
          let b = this.get(0),
        ...
        prev: function (a) {
          ...
          if ("undefined" == typeof a)
            b.a =
              ...
              null != b.a[0].previousElementSibling
                ? [b.a[0].previousElementSibling]
                : [];
        ...
        next: function (a) {
          ...
          if ("undefined" == typeof a)
            b.a =
              "undefined" != typeof b.a[0] && null != b.a[0].nextElementSibling
                ? [b.a[0].nextElementSibling]
                : [];
          else if ("undefined" != typeof b.a[0]) {
        ...
        closest: function (a) {
          ...
          if ("string" === typeof a) {
            ...
            null !== b &&
            "undefined" != typeof b.matches &&
            "undefined" != typeof a.matches
          ) {
            if (b !== a) for (; (b = b.parentElement) && b !== a; );
            c.a = null == b ? [] : [b];
          }
          c.length = c.a.length;
          return c;
        ...
        find: function (a) {
          ...
          this.forEach(function (c) {
            null !== c &&
              ...
              (b.a = b.a.concat(
                Array.prototype.slice.call(c.querySelectorAll(a))
              ));
          });
          b.length = b.a.length;
          return b;
        ...
        removeClass: function (a) {
          if ("undefined" != typeof a) {
            ...
            this.forEach(function (b) {
              0 < b.classList.length &&
                b.classList.remove.apply(b.classList, b.classList);
            });
          return this;
        },
        is: function (a) {
            ...
            if (1 == arguments.length)
              if ("select-multiple" == b.type) {
                ...
                for (let c = 0, d = b.options.length, e; c < d; c++)
                  (e = b.options[c]), (e.selected = -1 != a.indexOf(e.value));
              } else b.value = a;
            else
              return "select-multiple" == b.type
                ? Array.prototype.map.call(b.selectedOptions, function (c) {
                    return c.value;
                  })
                : b.value;
          return this;
        ...
        prop: function (a, b) {
          ...
          this.forEach(function (e) {
            2 == d.length
              ? (e[a] = b)
              : (c = "undefined" != typeof e[a] ? e[a] : null);
          });
        ...
        css: function (a, b) {
          ...
          for (let e = 0; e < c.length; e++)
            if (((d = c[e]), 1 == arguments.length))
              if ("object" == typeof a)
                Object.keys(a).forEach(function (f) {
                  d.style[f] = a[f];
                });
              else return window.getComputedStyle(d)[a];
            else d.style[a] = b;
          return this;
        },
        position: function () {
        ...
        offset: function () {
          let a = this.get(0);
          return null != a
            ? WPD.dom._fn.hasFixedParent(a)
              ? a.getBoundingClientRect()
              : WPD.dom._fn.absolutePosition(a)
            : { top: 0, left: 0 };
        },
          ...
          let a = arguments,
            b = function (d, e) {
              ...
              if (
                ...
                null != g && (f = WPD.dom(g));
              } else f = WPD.dom(e.target).closest(d[1]);
              if (null != f && 0 < f.closest(this).length) {
                g = [];
                g.push(e);
                if ("undefined" != typeof d[4])
                  for (e = 4; e < d.length; e++) g.push(d[e]);
                d[2].apply(f.get(0), g);
              }
            },
            c = a[0].split(" ");
            ...
            if ("string" == typeof a[1])
              ...
              for (let f = 0; f < c.length; f++) {
                ...
                this.forEach(function (h) {
                  WPD.dom._fn.hasEventListener(h, g, a[1]) ||
                    (h.addEventListener(g, a[1], a[2]),
                    (h._wpd_el =
                      "undefined" == typeof h._wpd_el ? [] : h._wpd_el),
                    h._wpd_el.push({
                      type: g,
                      func: a[1],
                      trigger: a[1],
                ...
                a.split(" ").forEach(function (d) {
                  if ("undefined" == typeof b) {
                    ...
                    c._wpd_el.forEach(function (f) {
                      f.type == d && f.trigger == b
                        ? c.removeEventListener(d, f.func, f.args)
                        : e.push(f);
                    });
                    c._wpd_el = e;
                  }
        ...
        trigger: function (a, b, c, d) {
          ...
          this.forEach(function (e) {
            ...
            d &&
              ...
              "undefined" != typeof jQuery._data &&
              "undefined" != typeof jQuery._data(e, "events") &&
              "undefined" != typeof jQuery._data(e, "events")[a] &&
              (jQuery(e).trigger(a, b), (f = !0));
            !f && c && ((f = new Event(a)), (f.detail = b), e.dispatchEvent(f));
            if ("undefined" != typeof e._wpd_el)
              ...
              for (;;) {
                h = h.parentElement;
                if (null == h) break;
                "undefined" != typeof h._wpd_el &&
                  h._wpd_el.forEach(function (k) {
        ...
        clone: function () {
          let a = this.get(0);
          null != a
            ? ((this.a = [a.cloneNode(!0)]), (this.length = this.a.length))
            : (this.a = []);
          this.length = this.a.length;
          return this;
        },
        remove: function (a) {
          if ("undefined" != typeof a) return a.parentElement.removeChild(a);
          this.forEach(function (b) {
            if (null != b.parentElement) return b.parentElement.removeChild(b);
          });
          this.a = [];
          this.length = this.a.length;
          return null;
        ...
        (WPD.dom._fn = {
          bodyTransform: function () {
            ...
            if ("undefined" !== typeof WebKitCSSMatrix) {
              ...
              "undefined" != typeof c.transform &&
                ((c = new WebKitCSSMatrix(c.transform)),
          ...
          hasFixedParent: function (a) {
            if (0 != WPD.dom._fn.bodyTransformY()) return !1;
            do if ("fixed" == window.getComputedStyle(a).position) return !0;
            while ((a = a.parentElement));
            return !1;
          },
          hasEventListener: function (a, b, c) {
            if ("undefined" == typeof a._wpd_el) return !1;
          ...
          absolutePosition: function (a) {
            if (!a.getClientRects().length) return { top: 0, left: 0 };
    ...
    return 1 <= arguments.length
      ? WPD.dom.fn.$.apply(WPD.dom.fn, arguments)
      : WPD.dom.fn;
  };
  WPD.dom();
...
(function () {
  if ("undefined" != typeof WPD.dom.fn.animate) return !1;
  WPD.dom.fn._animate = {
    easing: {
      linear: function (a) {
        return a;
      ...
      easeInOutQuad: function (a) {
        return 0.5 > a ? 2 * a * a : 1 - Math.pow(-2 * a + 2, 2) / 2;
      },
  ...
  WPD.dom.fn.animate = function (a, b, c) {
    ...
    this.forEach(function (e) {
      ...
      !1 === a
        ...
        : ((q =
            "undefined" != typeof d._animate.easing[c]
              ? d._animate.easing[c]
              : d._animate.easing.easeInOutQuad),
          Object.keys(a).forEach(function (l) {
            -1 < l.indexOf("scroll")
              ? (k[l] = e[l])
              : (k[l] = parseInt(window.getComputedStyle(e)[l]));
            m[l] = a[l] - k[l];
          }),
          (f = (b / 1e3) * 60),
...
(function () {
  let a = WPD.dom;
  if ("undefined" != typeof WPD.dom.fn.unhighlight) return !1;
  WPD.dom.fn.unhighlight = function (b) {
    let c = { className: "highlight", element: "span" };
    a.fn.extend(c, b);
    ...
    function d(g, h, k, m, n) {
      ...
      if (3 === g.nodeType) {
        if (
          ...
          return (
            (k = document.createElement(k || "span")),
        ...
        1 === g.nodeType &&
        g.childNodes &&
        !/(script|style)/i.test(g.tagName) &&
        0 < !a(g).closest(n).length &&
        (g.tagName !== k.toUpperCase() || g.className !== m)
      )
...
(function () {
  if ("undefined" != typeof WPD.dom.fn.serialize) return !1;
              ...
              switch (a.elements[b].type) {
                ...
                case "select-multiple":
                  for (c = a.elements[b].options.length - 1; 0 <= c; --c)
                    a.elements[b].options[c].selected &&
                      d.push(
                        a.elements[b].name +
                          "=" +
                          encodeURIComponent(a.elements[b].options[c].value)
                      );
              }
              break;
            case "BUTTON":
      ...
      if (a.hasOwnProperty(d)) {
        ...
        c.push(
          null !== f && "object" === typeof f
            ? WPD.dom.fn.serializeForAjax(f, e)
...
(function () {
  if ("undefined" != typeof WPD.dom.fn.inViewPort) return !1;
  WPD.dom.fn.inViewPort = function (a, b) {
    ...
    null == b && (b = window);
    b === window
      ? ((e = window.innerWidth || 0), (d = window.innerHeight || 0))
      : ((e = b.clientWidth),
        (d = b.clientHeight),
...
(function () {
  if ("undefined" != typeof WPD.dom.fn.ajax) return !1;
...
(function () {
  ...
  a.removeFilter = function (b, c) {
    "undefined" != typeof a.filters[b] &&
      ("undefined" == typeof c
        ? (a.filters[b] = [])
        : a.filters[b].forEach(function (d, e) {
  ...
  a.applyFilters = function (b) {
    let c = [],
      ...
      e = arguments[1];
    "undefined" !== typeof a.filters[b] &&
      0 < a.filters[b].length &&
      (a.filters[b].forEach(function (f) {
        c[f.priority] = c[f.priority] || [];
        c[f.priority].push({ scope: f.scope, callback: f.callback });
      }),
      d.splice(0, 2),
...
window.WPD.intervalUntilExecute = function (a, b, c, d) {
  ...
  if (!1 === g)
    e = setInterval(function () {
      g = "function" === typeof b ? b() : b;
      f++;
      if (f > d) return clearInterval(e), !1;
      if (!1 !== g) return clearInterval(e), a(g);
    }, c);
  else return a(g);
};
